...
`run_cross_dataset_synthesis.py` consumes each dataset's seed-summary CSV and bootstrap CSV and writes three deterministic artifacts under `results/`: `gain_table.csv`, `positional_ndcg10.csv`, and `synthesis.md`.
